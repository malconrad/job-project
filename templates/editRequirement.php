...
<head>
    ...
    <link rel="stylesheet" href="css/editrequire.css">
    <title>Editing requirement</title>
</head>
<body>
<section class="edit-contain">
    ...
    <div class="animations-container">
        ...
        <div class="conta">
          ...
          <h2> Editing Requirements</h2>
            <form action="editRequire.php" method="POST" enctype="multipart/form-data" autocomplete="off">
              <div class="editfield">
                <input type="text" name="requirement"  value="<?=$single->requirements;?>" id="editInput">
                <label for="">Edit  requirement</label>
                <span></span>

              </div>
              <div class="edit_close">
                  <input type="hidden" name="job_id" value="<?=$job->id;?>">
              <input type="hidden" name="reqid" value="<?php echo $single->id;?>">
              <input type="submit" value="Submit" name="submit" class="ed-Btn">
              <span class="clearEdit" onclick="document.getElementById('editInput').value='';">&times;</span>
              </div>
